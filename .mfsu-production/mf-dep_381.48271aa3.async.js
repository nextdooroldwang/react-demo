        ...
        (function (t, n) {
          ...
          function ie(e) {
            var t,
              n,
              s = {};
            for (n in e) o(e, n) && ((t = se(n)), t && (s[t] = e[n]));
            return s;
          }
          var re = {};
          function ae(e, t) {
          ...
          function me(e) {
            return (e = se(e)), T(this[e]) ? this[e]() : this;
          }
          function _e(e, t) {
            if ('object' === typeof e) {
              e = ie(e);
            ...
            } else if (((e = se(e)), T(this[e]))) return this[e](t);
            return this;
          }
          var ye,
            ge = /\d/,
          ...
          function ot(e, t, n) {
            ...
            return n
              ? 'MMM' === t
                ? ((i = Ae.call(this._shortMonthsParse, a)),
                  -1 !== i ? i : null)
                : ((i = Ae.call(this._longMonthsParse, a)), -1 !== i ? i : null)
              : 'MMM' === t
              ? ((i = Ae.call(this._shortMonthsParse, a)),
                -1 !== i
                  ? i
                  : ((i = Ae.call(this._longMonthsParse, a)),
                    -1 !== i ? i : null))
              : ((i = Ae.call(this._longMonthsParse, a)),
                -1 !== i
                  ? i
          ...
          function At(e, t, n) {
            ...
            return n
              ? 'dddd' === t
                ? ((i = Ae.call(this._weekdaysParse, a)), -1 !== i ? i : null)
                : 'ddd' === t
                ? ((i = Ae.call(this._shortWeekdaysParse, a)),
                  -1 !== i ? i : null)
                : ((i = Ae.call(this._minWeekdaysParse, a)),
                  -1 !== i ? i : null)
              : 'dddd' === t
              ? ((i = Ae.call(this._weekdaysParse, a)),
                -1 !== i
                  ? i
                  : ((i = Ae.call(this._shortWeekdaysParse, a)),
                    -1 !== i
          ...
          function cn(e) {
            ...
            while (r < e.length) {
              (i = dn(e[r]).split('-')),
                ...
                (n = n ? n.split('-') : null);
              while (t > 0) {
                if (((s = fn(i.slice(0, t).join('-'))), s)) return s;
          ...
          function Cn(e) {
            ...
            if (n) {
              if (
                ((t = Tn(n[4], n[3], n[2], n[5], n[6], n[7])), !Rn(n[1], t, e))
              )
                return;
              (e._a = t),
          ...
          function ms(e, t, n) {
            ...
            if (null != e) {
              if ('string' === typeof e) {
                if (((e = ds(Pe, e)), null === e)) return this;
          ...
          function Bs(e, t, n) {
            ...
            if (((s = cs(e, this)), !s.isValid())) return NaN;
            switch (
              ((i = 6e4 * (s.utcOffset() - this.utcOffset())), (t = se(t)), t)
            ) {
              case 'year':
                r = Js(this, s) / 12;
                break;
